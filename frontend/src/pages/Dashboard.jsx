...
import { PageHeader, StatCard, LoadingScreen, ErrorState } from '../components/ui';
...
const Dashboard = () => {
  ...
  if (loading) return <LoadingScreen message="Loading neural nodes..." />;
  if (error || !data) return <ErrorState message="Failed to sync with ScrumMaster brain." onRetry={refetch} />;
